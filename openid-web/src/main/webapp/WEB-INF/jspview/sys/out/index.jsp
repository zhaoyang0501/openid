                ...
                <div class="ibox ">
      		 	...
      		 	<div class="ibox-content">
 		 			<div class="row">
                            ...
                            <form class="form-horizontal" action="/sys/out/foodOut" method="post">
		                           	<table class='table table-bordered'>
		                           		<thead>
		                           		<tr style="text-align: center;" ><td colspan="6" ><h3>出库<h3></td></tr>
		                           		</thead>
		                           		<tbody>
		                           			<tr>
		                           				<td>货物编码（可用扫描枪）</td>
		                           			...
		                           			<tr>
		                           				<td > 客户</td>
		                           				<td><input name="buyer" class="form-control"/></td>
		                           			...
		                           			<tr>
		                           				<td > 出库日期</td>
		                           				<td> <input name="outDate"  class="form-control"/></td>
		                           	...
		                           	<div class="text-center">
			                        	<button type="submit" class="btn btn-primary"><i ></i> 立即出库</button>
			                    	</div>
		                           	</form>
                            </div>
                        </div>
